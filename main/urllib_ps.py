...
#        response = requests.get(URL, headers = {'User-Agent': UA, 'Referer': URL}).content
        ...
        return r'<span style="color:#ff0000;font-size:25px;">ERROR! QwQ</span><br/>' + str(e.code) + ' ' + str(e.reason)
    except urllib2.URLError, e:
        return r'<span style="color:#ff0000;font-size:25px;">ERROR! QwQ</span><br/>' + str(e.reason)
    except httplib.HTTPException, e:
        return r'<span style="color:#ff0000;font-size:25px;">ERROR! QwQ</span><br/>HTTPException: ' + str(e)
